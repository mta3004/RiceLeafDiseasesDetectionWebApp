...
var NucleusLayer = function (_a) {
    ...
    var particles = Array.from({ length: particlesPerLayer })
        ...
        return (React.createElement(React.Fragment, { key: "particle-".concat(rotationAngle) },
            effectiveBorderWidth > 0 && i === 0 && (React.createElement("mask", { id: "layer-".concat(startingAngle, "-bottom-particle") },
            ...
            React.createElement("circle", __assign({}, particleDimensions, { r: particleSize, fill: particleFillColor, stroke: particleBorderColor, strokeWidth: effectiveBorderWidth, mask: i > Math.floor(particlesPerLayer / 2) ? "url('#layer-".concat(startingAngle, "-bottom-particle')") : undefined }))));
    });
