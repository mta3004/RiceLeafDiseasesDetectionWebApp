...
var NucleusLayer = function (_a) {
    var particleFillColor = _a.particleFillColor, particleBorderColor = _a.particleBorderColor, particleBorderWidth = _a.particleBorderWidth, particlesPerLayer = _a.particlesPerLayer, particleSize = _a.particleSize, distanceFromCenter = _a.distanceFromCenter, orbitTime = _a.orbitTime, startingAngle = _a.startingAngle;
    var particles = Array.from({ length: particlesPerLayer })
        ...
        return (React__namespace.createElement(React__namespace.Fragment, { key: "particle-".concat(rotationAngle) },
            effectiveBorderWidth > 0 && i === 0 && (React__namespace.createElement("mask", { id: "layer-".concat(startingAngle, "-bottom-particle") },
            ...
            React__namespace.createElement("circle", __assign({}, particleDimensions, { r: particleSize, fill: particleFillColor, stroke: particleBorderColor, strokeWidth: effectiveBorderWidth, mask: i > Math.floor(particlesPerLayer / 2) ? "url('#layer-".concat(startingAngle, "-bottom-particle')") : undefined }))));
    });
